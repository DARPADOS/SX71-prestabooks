...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    @Override
    public List<Employee> findByFirstNameLikeOrLastNameLike(String searchTerm) throws Exception {
        return employeeRepository.findByFirstNameLikeOrLastNameLike(searchTerm);
    }
}
